...
Object.defineProperty(exports, "__esModule", { value: true });
const Victor = __webpack_require__(/*! victor */ "./node_modules/victor/index.js");
var Direction;
(function (Direction) {
...
const DIRECTIONS_COORDINATES = [[-1, 0], [1, 0], [0, -1], [0, 1]];
function toVictor(d) {
    return Victor.fromArray(DIRECTIONS_COORDINATES[d]);
}
exports.toVictor = toVictor;
...
class GameCanvas {
    constructor() {
        this.WIDTH_IN_CELLS = 20;
        this.HEIGHT_IN_CELLS = 20;
        this.CELL_SIZE = 10;
    ...
    fillCell(position) {
        ...
        this.context.fillRect(position.x * this.CELL_SIZE, position.y * this.CELL_SIZE, this.CELL_SIZE, this.CELL_SIZE);
    }
    clear() {
        this.context.fillStyle = 'white';
        this.context.fillRect(0, 0, parseInt(this.canvas.attr('width')), parseInt(this.canvas.attr('height')));
    }
}
...
const game_screen_1 = __webpack_require__(/*! ./screens/game-screen */ "./src/screens/game-screen.ts");
const screen_1 = __webpack_require__(/*! ./screens/screen */ "./src/screens/screen.ts");
let screens = [];
let gameScreen = new game_screen_1.default();
screens[screen_1.Screens.GAME_SCREEN] = gameScreen;
let currentScreen = screen_1.Screens.GAME_SCREEN;
...
const game_canvas_1 = __webpack_require__(/*! ../game-canvas */ "./src/game-canvas.ts");
const Mousetrap = __webpack_require__(/*! mousetrap */ "./node_modules/mousetrap/mousetrap.js");
const screen_1 = __webpack_require__(/*! ./screen */ "./src/screens/screen.ts");
class GameScreen extends screen_1.Screen {
    constructor() {
        super();
        this.gameCanvas = new game_canvas_1.default();
        this.snakeTimer = new timer_1.default(300, this.onSnakeTimerTick.bind(this), true);
    }
    init() {
        this.snake = new snake_1.default(new Victor(10, 10), 3, direction_1.Direction.DOWN);
        this.snakeTimer.stop();
        this.bindEvents();
    }
    bindEvents() {
        Mousetrap.bind(['a', 'left'], () => this.snake.setDirectionToMove(direction_1.Direction.LEFT));
        Mousetrap.bind(['d', 'right'], () => this.snake.setDirectionToMove(direction_1.Direction.RIGHT));
        Mousetrap.bind(['w', 'up'], () => this.snake.setDirectionToMove(direction_1.Direction.UP));
        Mousetrap.bind(['s', 'down'], () => this.snake.setDirectionToMove(direction_1.Direction.DOWN));
    }
    unbindEvents() {
        Mousetrap.reset();
    }
...
var Screens;
(function (Screens) {
    Screens[Screens["GAME_SCREEN"] = 0] = "GAME_SCREEN";
...
const direction_1 = __webpack_require__(/*! ./direction */ "./src/direction.ts");
class Snake {
    constructor(position, length, directionToGrow) {
        const directionToGrowCoordinates = direction_1.toVictor(directionToGrow);
        this._body = [position.clone()];
        this.directionToMove = direction_1.getOppositeDirection(directionToGrow);
    ...
    setDirectionToMove(directionToMove) {
        if (this._body.length > 1) {
            let nextPositionAfterMoving = this._body[0].clone().add(direction_1.toVictor(directionToMove));
    ...
    getNextHeadPosition() {
        return this._body[0].clone().add(direction_1.toVictor(this.directionToMove));
    }
    makeStep() {
        for (let i = this._body.length - 1; i > 0; i--) {
            this._body[i] = this._body[i - 1];
        }
        this._body[0] = this._body[0].clone().add(direction_1.toVictor(this.directionToMove));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
class Timer {
    constructor(tickInterval, onTick, toAmountIdleTime = false) {

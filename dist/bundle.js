...
let gameCanvas = new game_canvas_1.default();
let snake = new snake_1.default(new Victor(10, 10), 3, direction_1.Direction.DOWN);
let snakeUpdater = new timer_1.default(1000, () => {
    debugger;
    snake.makeStep();
}, true);
snakeUpdater.start();

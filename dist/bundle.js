...
class Snake {
    constructor(position, length, direction) {
        const directionCoordinates = direction_1.toVictor(direction);
        this.body = [];
